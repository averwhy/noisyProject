    ...
    return (
        <div>
            ...
            <header className="App-header">
                ...
                <br style={{display: 'block', margin:'5px 0'}}/> {/*i HAVE to style this because it wont work otherwise*/}
                <Card bg='dark' text='light' style={{width: '20rem'}}>
                    <Card.Body>
                        ...
                        The source code to this website can be found here. It uses the MIT license.
                        </Card.Text>
